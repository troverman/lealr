...
table = db.define_table('plugin_uploadify_widget',
    ...
    Field('text1', 'upload', autodelete=True, comment='<- upload a txt file (max file size=1k)'),
    )
...
table.text1.widget = uploadify_widget
table.text1.requires = IS_EMPTY_OR([IS_UPLOADIFY_FILENAME(extension='txt'),
